...
df = pd.read_csv("/home/lorena/Documentos/ATIVIDADES-SCTEC/DeSafioExTra/titanic_dataset.csv")
...
print("Sobreviventes e não sobreviventes:")
...
print("Taxa geral de sobrevivência:", df['Survived'].mean())
print("Mulheres tiveram ~", df.groupby('Sex')['Survived'].mean()['female'], "chance de sobreviver (vs homens).")
